...
const openApiSpec = {
  ...
  paths: {
    ...
    "/api/create-linear-issues": {
      post: {
        summary: "Create issues in Linear",
        tags: ["Integrations"],
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/LinearTickets" },
            },
          },
        },
        responses: {
    ...
    "/api/yutori-browser-agent": {
      post: {
        summary: "Start Yutori browser agent tasks",
        tags: ["Yutori"],
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/BrowserAgentRequest" },
            },
          },
        },
        responses: {
    ...
    "/api/yutori-browser-agent/{id}": {
      get: {
        summary: "Get Yutori browser agent task status",
        tags: ["Yutori"],
        parameters: [
          {
            name: "id",
    ...
    "/api/create-scout": {
      post: {
        summary: "Identify inaccessible URLs using Yutori Scout",
        tags: ["Yutori"],
        responses: {
          200: {
            description: "Found inaccessible URLs",
          },
        },
      },
    },
    "/api/find-owners": {
      post: {
        summary: "Find website owners/contacts using Yutori Research",
        tags: ["Yutori"],
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/FindOwnersRequest" },
            },
          },
        },
        responses: {
    ...
    "/api/test-yutori": {
      post: {
        summary: "Analyze automation logs and screenshots using Gemini",
        tags: ["AI Utilities"],
        requestBody: {
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/TestYutoriRequest" },
            },
          },
        },
        responses: {
