      ...
      <div>
            ...
            .map((ticket, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-sm text-gray-600 leading-relaxed group-hover:text-gray-700 ${isExpanded ? '' : 'line-clamp-2'}`}>
                    {ticket.description}
                  </p>
                </div>
              );
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <button
            ...
            className="w-full bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2 transition-all active:scale-[0.99] shadow-sm hover:shadow-md"
          >
