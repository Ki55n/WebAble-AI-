...
export default function AutomationForm({
  ...
  onPanelToggle,
  mode = 'embedded',
}: AutomationFormProps = {} as AutomationFormProps) {
...
Completion
  ...
  const handleDeleteSession = (sessionId: string) => {
    if (typeof window !== 'undefined' && !window.confirm('Delete this saved audit history item?')) {
      return;
    }
  ...
  const handleClearHistory = () => {
    if (typeof window !== 'undefined' && !window.confirm('Clear all saved audit history?')) {
      return;
    }
