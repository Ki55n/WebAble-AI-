    ...
    <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top,#f4fff9_0%,#ebfaf4_28%,#f8fffc_58%,#ffffff_100%)] text-gray-900">
      <header className="fixed top-0 z-50 w-full border-b border-emerald-100/80 bg-white/70 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between md:w-auto md:justify-end md:gap-4">
            <span className="text-sm font-medium text-gray-600">Scan. Verify. Ship accessibly.</span>
      ...
      <main>
        <section className="relative isolate px-4 pb-18 pt-44 sm:px-6 sm:pt-40 md:pb-24 md:pt-36">
          ...
          <div className="hero-spotlight absolute left-1/2 top-24 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-emerald-300/20 blur-3xl"></div>
          <div className="hero-spotlight absolute right-[8%] top-28 h-[24rem] w-[24rem] rounded-full bg-teal-300/20 blur-3xl"></div>
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1.08fr_0.92fr]">
            <div className="max-w-3xl">
              ...
              <div className="hero-reveal-delay-3 mt-10 flex flex-col gap-4 xl:flex-row xl:items-center">
                ...
                <div className="inline-flex min-h-16 max-w-xl items-center gap-3 rounded-full border border-emerald-100 bg-white/85 px-5 py-4 text-sm text-gray-600 shadow-[0_12px_30px_rgba(15,23,42,0.06)] backdrop-blur">
                  <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-800">
                    24/7
                  </span>
                  <span className="leading-6">
                    Continuous audit visibility with zero onboarding friction
                  </span>
                </div>
              </div>
            ...
            <div className="relative lg:pl-6">
              ...
              <div className="hero-card relative overflow-hidden rounded-[2rem] border border-white/70 bg-[linear-gradient(145deg,rgba(255,255,255,0.9),rgba(237,253,245,0.88))] p-6 shadow-[0_28px_90px_rgba(6,95,70,0.16)] backdrop-blur-2xl sm:p-8">
                <div className="absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-emerald-300 to-transparent"></div>
                ...
                <div className="mt-8 grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="hero-float-card rounded-2xl border border-emerald-100 bg-gradient-to-r from-emerald-900 to-teal-800 p-5 text-white shadow-[0_18px_40px_rgba(6,95,70,0.22)]">
        ...
        <section className="mx-auto max-w-6xl px-6 pb-16 pt-4">
          <Link
            href="/vendor-audit"
            className="group relative overflow-hidden rounded-3xl border border-white/80 bg-white/80 p-8 shadow-[0_16px_40px_rgba(15,23,42,0.06)] backdrop-blur transition hover:-translate-y-0.5 hover:shadow-[0_24px_48px_rgba(15,23,42,0.10)] flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between"
          >
            {/* Subtle background blobs — matches hero card pattern */}
            <div className="pointer-events-none absolute right-0 top-0 h-40 w-40 rounded-full bg-emerald-300/10 blur-3xl" />
            <div className="pointer-events-none absolute bottom-0 left-0 h-32 w-32 rounded-full bg-teal-300/10 blur-3xl" />
            {/* Top shimmer line — matches hero card */}
            <div className="pointer-events-none absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-emerald-200 to-transparent" />
            ...
            <div className="relative">
              ...
              <h3 className="mt-4 text-2xl font-semibold tracking-tight text-emerald-950 sm:text-3xl">
                Audit vendor privacy &amp; security risk.
              </h3>
              <p className="mt-3 max-w-xl text-base leading-7 text-gray-600">
                Run a TinyFish-powered security audit on any third-party vendor. Get a risk score, detailed findings, and a downloadable PDF report — stored automatically.
              </p>
            </div>

            <div className="relative shrink-0">
              <span className="inline-flex items-center gap-2 rounded-full bg-emerald-800 px-6 py-3 text-sm font-semibold text-white shadow-[0_14px_30px_rgba(6,95,70,0.25)] transition group-hover:bg-emerald-900">
                Try Vendor Audit
